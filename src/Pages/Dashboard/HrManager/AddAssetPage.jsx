    ...
    <div className="p-6">
      ...
      >
       <div className="grid grid-cols-2 gap-3 md:gap-10">
        ...
        <div>
          ...
          <select
            className="w-full p-2 border select rounded"
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-10">
        ...
        <div>
          ...
          <select
            className="w-full select p-2 border rounded"
        ...
        <div>
          ...
          <input
            type="number"
            className="w-full p-2 border rounded input validator"
        ...
        <button
          ...
          className="px-5 py-2 cursor-pointer bg-[#063A3A] text-white rounded shadow hover:opacity-90 disabled:opacity-50"
        >
